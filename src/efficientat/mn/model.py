...
from src.efficientat.mn.utils import cnn_out_size
...
class MN(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        elif self.head_type == "multihead_attention_pooling":
    ...
    def _forward_impl(self, x: Tensor) -> Union[Tuple[Tensor, Tensor], Tuple[Tensor, List[Tensor]]]:
        features = []
...
def get_model(num_classes: int = 527, pretrained_name: str = None, width_mult: float = 1.0,
              ...
              input_dim_t: int = 1000, se_dims: str = 'c', se_agg: str = "max", se_r: int = 4, features_only=False,
              out_indices=None):
    """
